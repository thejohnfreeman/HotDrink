(function () {
  ...
  Variable.prototype.isSource = function isSource() {
  ...
  Variable.prototype.publishAll = function publishAll() {
    WARNINGIF(!this.isChanged(), "expected a change to publish");
    Object.keys(this.drafts).forEach(function (evt) {
      this.publish(evt);
    }, this);
  };
